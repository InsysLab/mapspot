...
<div id="page-container">
	...
	Map Analytics : ${map.description}
	<div id="content-container">
		Total visits: ${fn:length(visits)}
		<table style="min-width:500px;">
			<thead>
				<tr><th>IP Address</th><th>Date/Time</th></tr>
			</thead>
			<c:forEach var="visit" items="${visits}">
				<tr>
					<td>${visit.ipAddress}</td>
					<td><fmt:formatDate type="both" value="${visit.dateVisited}" /></td>
				</tr>
			</c:forEach>		
		</table>
	</div>
